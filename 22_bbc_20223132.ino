...
#define _EMA_ALPHA 0.1      // EMA weight (range: 0 to 1)
                          // Setting _EMA_ALPHA to 0 effectively disables EMA filter.

// Servo adjustment
#define _DUTY_MIN 593  // Servo angle: D degree
#define _DUTY_NEU 1628  // Servo angle: 0 degree
#define _DUTY_MAX 2563  // Servo angle: E degree
//#define _DUTY_MAX 530  // Servo angle: D degree
//#define _DUTY_NEU 1100  // Servo angle: 0 degree
#//define _DUTY_MIN 2670  // Servo angle: E degree
#define _SERVO_ANGLE_DIFF 220 // Replace with |D - E| degree
#define _SERVO_SPEED 550 // servo speed limit (unit: degree/second)

#define _BANGBANG_RANGE 900

// global variables
float dist_filtered, dist_ema;
float dist_target = 105.0; // unit: mm
...
{
  return (906.0 + a_value*(-4.87) + 9.42*0.001*a_value*a_value + (-6.3)*0.000001*a_value*a_value*a_value); // Replace this with the equation obtained from nonlinear regression analysis
}
